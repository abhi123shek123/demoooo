/*
 * package com.vocalink.demo.security;
 * 
 ...
 * 
 * @Component public class JwtUtil implements Serializable {
 * 
 * private static final long serialVersionUID = -7894561230789456123L;
 * 
 ...
 * claimsResolver.apply(claims); } private Claims getAllClaimsFromToken(String
 * token) { return
